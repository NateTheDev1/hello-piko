...
const styles: Record<string, React.CSSProperties> = {
  ...
  card: {
    ...
    borderRadius: "1rem", padding: "2rem 3rem",
    textAlign: "center", minWidth: "18rem",
    display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem",
  },
  avatar: {
    width: "5rem", height: "5rem", borderRadius: "50%",
    display: "flex", alignItems: "center", justifyContent: "center",
    fontSize: "2rem", fontWeight: 800, color: "#fff", marginBottom: "0.5rem",
  },
  ...
  btn: {
    ...
    fontFamily: "inherit", fontSize: "1rem", fontWeight: 700, cursor: "pointer",
  },
};
